...
${JSON.stringify(e)}`,buttons:["OK"]})}async function lt(){const e=A(),t=await O();if(t===void 0){await N(e);return}const i=Array.isArray(t[c])?t[c]:[];if(i.some(I)){await a.MarkEdit.showAlert({title:"Toolbar button already configured",message:`A toolbar toggle for the Outline Sidebar is already in your settings.json.
